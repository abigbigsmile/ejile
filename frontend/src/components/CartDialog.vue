<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="num" label="数量" align="center" width="160">
        <template scope="scope">
          <el-input-number v-model="scope.row.num" size="mini" :min="0" @change="handleChange(scope.row)" />
        </template>
      </el-table-column>
    ...
    <div style="margin-top: 20px">
      ...
      <el-button type="warning" icon="el-icon-delete" @click.native="Clear">清空</el-button>
  ...
  data() {
    return {
      cartList: [{
        ...
        goodsName: '炒面',
        num: 1,
        picture: 'http://localhost:8080/ejile/upload/201907121000433.jpg',
        price: 200,
        shopName: 'mai',
        sid: 1,
        total: 200

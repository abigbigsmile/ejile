<template>
  <div v-if="found">
    <el-row>
      ...
      <el-col :span="1"><div class="grid-content bg-white" /></el-col>
      <el-col :span="4">
    ...
    <el-container>
      <el-aside width="400" style="margin-left: 60px;margin-top: 20px;">
        <el-menu>
          <el-menu-item index="1" class="title" @click="index1">
            <i class="el-icon-fork-spoon" />
            <span slot="title">点单</span>
          </el-menu-item>
          <el-menu-item index="2" class="title" @click="index2">
            <i class="el-icon-chat-square" />
            <span slot="title">评价</span>
          </el-menu-item>
          <el-menu-item index="3" class="title" @click="index3">
      ...
      <el-main>
        ...
        <el-row v-if="index === 3">
          <el-col :span="19" :offset="1">
            <ContactDialog :id="SID" :other="SID" />
          </el-col>
        </el-row>
      </el-main>
    </el-container>

  ...
  <div>
    ...
    <div v-show="switchValue === '1'">
      ...
      <el-form :inline="true" :model="searchForm" class="demo-form-inline">
        <el-form-item label="最小年龄">
          <el-input v-model="searchForm.ageBegin" placeholder="请输入用户最小年龄" />
        </el-form-item>
        <el-form-item label="最大年龄">
          <el-input v-model="searchForm.ageEnd" placeholder="请输入用户最大年龄" />
        </el-form-item>
        <el-form-item label="电话号码">
          <el-input v-model="searchForm.tel" placeholder="请输入用户电话号码" />
        </el-form-item>
        <el-form-item label="地址">
          <el-input v-model="searchForm.address" placeholder="请输入用户地址" />
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-col :span="14" :offset="5">
      <el-tabs v-model="activeName">
        <el-tab-pane label="全部" name="全部">
          ...
          <el-table :data="dataInPage">
                    ...
                    <el-container>
                      <el-aside>
                        ...
                        <el-form-item>
                          <div>
                            <!-- 默认 -->
                            <el-image v-if="card.picture === '' || card.picture === null" style="width: 100px; height: 100px" :src="require('@/assets/img/default.jpg')" fit="fill" />
                            <!-- 商家添加的 -->
                            <el-image v-else style="width: 100px; height: 100px" :src="card.picture" fit="fill" />
                          </div>
                        </el-form-item>
                      </el-aside>
                      <el-main>
            ...
            <el-table-column label="操作" width="150" align="center">
              <template slot-scope="scope">
                <el-button v-if="scope.row.some(x => x.state === '未完成')" type="success" size="small" @click="confirmSomeOrder(scope.row)">接单</el-button>
        ...
        <el-tab-pane label="未完成" name="未完成">
          <el-table :data="dataInPage.filter(x => x.some(y => y.state === '未完成'))">
            ...
            <el-table-column label="操作" width="150" align="center">
              <template slot-scope="scope">
                <el-button type="success" size="small" @click="confirmSomeOrder(scope.row)">接单</el-button>
              </template>
            </el-table-column>
            <!--   联系       -->
            <el-table-column label="联系" width="150">
      ...
      <el-dialog
        ...
        width="65%"
      >
        <ContactDialog v-if="dialogVisible" :other="nowContactConsumer" />
      </el-dialog>
      ...
      orderList: [
        {
          ...
          id: 4,
          num: 12,
          picture: 'http://localhost:8080/ejile/upload/201907070859253.jpg',
          price: 200,
          shopName: 'mai',
          sid: 1,
          state: '已完成',

    ...
    <el-col :span="14" :offset="5">
            ...
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="商品图片">
                <div class="block">
                  ...
                  />
                  <!-- 商家添加的 -->
                  <el-image v-else style="width: 100px; height: 100px" :src="props.row.pictureUrl" fit="fill" />
                </div>
              </el-form-item>
            </el-form>
          </template>
      ...
      <el-dialog title="菜单编辑" :visible.sync="dialogFormVisible" :before-close="handleClose" center>
        ...
        <div slot="footer" class="dialog-footer">
          <el-button class="reset-btn" @click="dialogFormVisible = false">取 消</el-button>
          <el-button type="warning" class="login-btn" @click="submitChange">确 定</el-button>
        </div>
      </el-dialog>
    </el-col>
  </el-row>

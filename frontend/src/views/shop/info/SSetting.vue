    ...
    <el-col :span="10" :offset="6">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
        <el-form-item label="店铺名称" prop="name">
          <el-input v-model="ruleForm.name" placeholder="请输入店铺名称" />
        </el-form-item>
        <el-form-item label="联系方式" prop="telephone">
          <el-input v-model="ruleForm.telephone" placeholder="请输入联系方式" />
        </el-form-item>
        <el-form-item label="店铺地址" prop="address">
          <el-input v-model="ruleForm.address" placeholder="请输入地址" />
        </el-form-item>
        <el-form-item label="店主姓名" prop="managerName">
          <el-input v-model="ruleForm.managerName" placeholder="请输入店主姓名" />
        </el-form-item>
        <el-form-item label="店主邮箱" prop="manageEmail">
          <el-input v-model="ruleForm.managerEmail" placeholder="请输入邮箱" />
        </el-form-item>
        <el-form-item>

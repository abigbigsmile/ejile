<template>
  <div>
    <el-steps :active="active" finish-status="success" dialog-visible="dialogVisible" align-center class="step">
      <el-step title="提交申请" description="填写店铺信息，提交经营资质照片，填写您的收款信息，方便开店后快速提现" />
      <el-step title="审核签约" description="等待资质审核（1-3个工作日），审核通过，短信签约" />
      <el-step title="录入菜单" description="录入商品" />
      <el-step title="正式营业" description="业务经理到店线下审核，审核通过即可开门营业" />
    </el-steps>

    <el-form ref="ruleForm" :model="applyForm" :rules="rules" label-width="150px" class="shop">
      <el-form-item label="门店名称" prop="name">
        <el-input v-model="applyForm.name" clearable />
      </el-form-item>

      <el-form-item label="联系人" prop="shopkeeper">
        <el-input v-model="applyForm.shopkeeper" clearable />
      </el-form-item>
      ...
      <el-form-item label="门店地址" prop="address">
        <el-input v-model="applyForm.address" clearable />
      </el-form-item>
      ...
      <el-form-item label="密码" prop="pass">
        <el-input v-model="applyForm.pass" type="password" autocomplete="off" />
      </el-form-item>
      <el-form-item label="确认密码" prop="checkPass">
        <el-input v-model="applyForm.checkPass" type="password" autocomplete="off" />
      </el-form-item>

  ...
  <div class="food-img">
    ...
    <el-form ref="signInForm" :model="form" :rules="rules" label-width="80px" class="signIn-box">
      ...
      <el-form-item label="确认密码" prop="checkPassword" class="form-item">
        <el-input v-model="form.checkPassword" type="password" prefix-icon="el-icon-lock" placeholder="请再次输入密码" clearable />
      </el-form-item>
      ...
      <el-button type="warning" class="sign-btn" @click="onSubmit">注 册</el-button>

  ...
  <div class="food-img">
    ...
    <el-form ref="loginForm" :model="form" :rules="rules" label-width="80px" class="login-box">
      ...
      <el-form-item label="手机号" prop="username" class="form-item">
        <el-input v-model="form.phone" type="text" prefix-icon="el-icon-mobile" placeholder="请输入手机号" clearable oninput="value=value.replace(/[^\d]/g,'')" maxlength="11" />
      </el-form-item>
      <el-form-item label="验证码" prop="password" class="form-item">
        <el-input v-model="form.code" type="code" placeholder="请输入验证码" clearable class="input-code" />
        <el-button v-if="disabled===false" type="warning" size="small" class="get-code-btn" :disabled="disabled" @click="sendcode">获取验证码</el-button>
        <el-button v-if="disabled===true" type="button" size="small" :disabled="disabled" @click="sendcode">{{ btntxt }}</el-button>
      </el-form-item>

      <el-row>
        <el-button type="warning" class="login-btn" @click="onSubmit">提 交</el-button>
    ...
    >
      <el-form :model="dialogForm">
        <el-form-item label="新密码" :label-width="formLabelWidth">
          <el-input v-model="dialogForm.pass" type="password" autocomplete="off" />
        </el-form-item>
        <el-form-item label="确认密码" :label-width="formLabelWidth">
          <el-input v-model="dialogForm.newPass" type="password" autocomplete="off" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <!--        <el-button @click="dialogFormVisible = false">取 消</el-button>-->
        <el-button type="primary" style="text-align: center" @click="changeFinish">确 定</el-button>
      </div>
    </el-dialog>
